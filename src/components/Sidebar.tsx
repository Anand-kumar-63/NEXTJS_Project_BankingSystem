...
const Sidebar = () => {
  return (
    <section className="sticky left-0 top-0 flex h-screen w-fit flex-col items-center gap-2 border-r border-gray-200 bg-white pt-8 text-white max-md:hidden sm:p-4 xl:p-3 2xl:w-[355px]">
